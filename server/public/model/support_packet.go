...
type SupportPacketOptions struct {
	...
	// CPUProfileDurationSeconds lets programmatic callers (e.g. tests) override how long to
	// sample the CPU profile for, in seconds. It is not exposed via the HTTP API.
